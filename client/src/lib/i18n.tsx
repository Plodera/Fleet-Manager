...
const translations = {
  en: {
    ...
    indents: {
      ...
      viewIndent: "View Indent",
      indentNo: "Indent No.",
      erpIndentNo: "ERP Indent No.",
      erpIndentNoRequired: "ERP Indent Number is required for approval",
      vehicle: "Vehicle",
      selectVehicle: "Select vehicle (optional)",
      purpose: "Purpose",
      purposePlaceholder: "Describe the purpose of this indent...",
      priority: "Priority",
      low: "Low",
      medium: "Medium",
      high: "High",
      ...
      noIndents: "No indents found",
      noIndentsMessage: "Create a new indent to get started.",
      deleteConfirm: "Are you sure you want to delete this indent?",
      approveConfirm: "Approve this indent?",
      rejectConfirm: "Reject this indent?",
      fulfillConfirm: "Mark this indent as fulfilled?",
      allStatuses: "All Status",
      allPriorities: "All Priorities",
      search: "Search indents...",
      itemCount: "Items",
      showingCount: "Showing {count} of {total} indents",
      allMonths: "All Months",
      approverConfig: "Indent Approvers",
      approverConfigDesc: "Assign staff to approve indents for specific departments",
  ...
  pt: {
    ...
    indents: {
      ...
      newIndent: "Nova Requisição",
      editIndent: "Editar Requisição",
      viewIndent: "Ver Requisição",
      indentNo: "Nº Requisição",
      erpIndentNo: "Nº ERP",
      ...
      noIndents: "Nenhuma requisição encontrada",
      noIndentsMessage: "Crie uma nova requisição para começar.",
      deleteConfirm: "Tem certeza que deseja eliminar esta requisição?",
      approveConfirm: "Aprovar esta requisição?",
      rejectConfirm: "Rejeitar esta requisição?",
      fulfillConfirm: "Marcar esta requisição como concluída?",
      allStatuses: "Todos os Estados",
      allPriorities: "Todas as Prioridades",
      search: "Pesquisar requisições...",
      itemCount: "Itens",
      showingCount: "Mostrando {count} de {total} requisições",
      allMonths: "Todos os Meses",
      approverConfig: "Aprovadores de Requisições",
      approverConfigDesc: "Atribuir funcionários para aprovar requisições de departamentos específicos",
