...
const translations = {
  en: {
    ...
    nav: {
      ...
      productionDashboard: "Steel Production",
    ...
    production: {
      configTitle: "Steel Production Config",
      configSubtitle: "Configure Power Automate webhook endpoints for SMS, CCM, and Rolling Mill",
      dashboardTitle: "Steel Production Dashboard",
      dashboardSubtitle: "Real-time KPIs from Rolling Mill, SMS, and CCM",
      rollingMill: "Rolling Mill",
      sms: "Steel Melting Shop (SMS)",
      ccm: "Continuous Casting Machine (CCM)",
      section: "Section",
      mtd: "MTD",
      rmTodayTons: "Today Tons",
      rmShifts: "Today Shifts",
      smsTodayHeats: "Today Heats",
      smsTodayKwh: "Today kWh",
      ccmTodayBillets: "Today Billets",
      ccmSequences: "Sequences",
      trendTons: "Daily Tons (30d)",
      trendKwh: "Daily kWh (30d)",
      trendBillets: "Daily Billets (30d)",
      recentReports: "Recent Reports",
      last50: "Last 50 received records",
      noData: "No data yet",
      noReports: "No reports received yet. Configure a Power Automate webhook to start.",
      active: "Active",
      inactive: "Inactive",
      webhookUrl: "Webhook URL",
      sharedSecret: "Shared Secret (Bearer Token)",
      secretPlaceholder: "Leave blank to disable authentication",
      enableSection: "Enable this section",
      saveSettings: "Save Settings",
      settingsSaved: "Settings saved",
      howToConfigure: "How to configure Power Automate",
      guideStep1: "In Power Automate, add an HTTP action after your Teams trigger",
      guideStep2: "Set Method: POST and URI to the Webhook URL above",
      guideStep3: "Set Body to the formatted key:value message text",
      guideStep4: "Optionally add Authorization: Bearer <your-secret> header",
      manualEntry: "Manual Entry",
      manualEntryTitle: "Add Manual Report",
      manualEntrySubtitle: "Manually add a report record for this section",
      reportDate: "Report Date",
      shift: "Shift",
      tonsProduced: "Tons Produced",
      billetsTaken: "Billets Taken",
      billetsRolled: "Billets Rolled",
      missRoll: "Miss Roll",
      cobleCut: "Coble Cut",
      hotOut: "Hot Out",
      breakdownMinutes: "Breakdown (min)",
      isDailyTotal: "Daily Total",
      heatNo: "Heat No.",
      startTime: "Start Time",
      tapingTime: "Taping Time",
      tapToTapMinutes: "Tap-to-Tap (min)",
      tapingTempC: "Taping Temp (°C)",
      ladleTempC: "Ladle Temp (°C)",
      totalKwh: "Total kWh",
      fcTons: "F/C Tons",
      incharge: "Incharge",
      noBillets: "No. of Billets",
      strandsRun: "Strands Run",
      mouldLife1: "Mould Life 1",
      mouldLife2: "Mould Life 2",
      ladleNo: "Ladle No.",
      ladleOpening: "Ladle Opening",
      tundishNo: "Tundish No.",
      tundishType: "Tundish Type",
      sequence: "Sequence",
  ...
  pt: {
    ...
    nav: {
      ...
      productionDashboard: "Produção de Aço",
      productionConfig: "Config. Produção",
      logout: "Sair",
    ...
    production: {
      configTitle: "Configuração de Produção de Aço",
      configSubtitle: "Configure os webhooks Power Automate para SMS, CCM e Laminagem",
      dashboardTitle: "Painel de Produção de Aço",
      dashboardSubtitle: "KPIs em tempo real: Laminagem, SMS e CCM",
      rollingMill: "Laminagem",
      sms: "Aciaria (SMS)",
      ccm: "Máquina de Lingotamento Contínuo (CCM)",
      section: "Secção",
      mtd: "MTD",
      rmTodayTons: "Ton. Hoje",
      rmShifts: "Turnos Hoje",
      smsTodayHeats: "Corridas Hoje",
      smsTodayKwh: "kWh Hoje",
      ccmTodayBillets: "Billets Hoje",
      ccmSequences: "Sequências",
      trendTons: "Ton. Diárias (30d)",
      trendKwh: "kWh Diários (30d)",
      trendBillets: "Billets Diários (30d)",
      recentReports: "Relatórios Recentes",
      last50: "Últimos 50 registos recebidos",
      noData: "Sem dados ainda",
      noReports: "Nenhum relatório recebido. Configure um webhook Power Automate para começar.",
      active: "Ativo",
      inactive: "Inativo",
      webhookUrl: "URL do Webhook",
      sharedSecret: "Segredo Partilhado (Bearer Token)",
      secretPlaceholder: "Deixar em branco para desativar autenticação",
      enableSection: "Ativar esta secção",
      saveSettings: "Guardar Definições",
      settingsSaved: "Definições guardadas",
      howToConfigure: "Como configurar o Power Automate",
      guideStep1: "No Power Automate, adicione uma ação HTTP após o gatilho do Teams",
      guideStep2: "Defina Método: POST e URI para o URL do Webhook acima",
      guideStep3: "Defina o Body com o texto formatado key:value",
      guideStep4: "Opcionalmente, adicione o cabeçalho Authorization: Bearer <segredo>",
      manualEntry: "Entrada Manual",
      manualEntryTitle: "Adicionar Relatório Manual",
      manualEntrySubtitle: "Adicionar manualmente um registo para esta secção",
      reportDate: "Data do Relatório",
      shift: "Turno",
      tonsProduced: "Toneladas Produzidas",
      billetsTaken: "Billets Retirados",
      billetsRolled: "Billets Laminados",
      missRoll: "Miss Roll",
      cobleCut: "Coble Cut",
      hotOut: "Hot Out",
      breakdownMinutes: "Avaria (min)",
      isDailyTotal: "Total Diário",
      heatNo: "Nº Corrida",
      startTime: "Hora de Início",
      tapingTime: "Hora de Vazamento",
      tapToTapMinutes: "Tap-to-Tap (min)",
      tapingTempC: "Temp. Vazamento (°C)",
      ladleTempC: "Temp. Panela (°C)",
      totalKwh: "Total kWh",
      fcTons: "Ton. F/C",
      incharge: "Responsável",
      noBillets: "Nº de Billets",
      strandsRun: "Veios em Marcha",
      mouldLife1: "Vida do Molde 1",
      mouldLife2: "Vida do Molde 2",
      ladleNo: "Nº Panela",
      ladleOpening: "Abertura da Panela",
      tundishNo: "Nº Distribuidor",
      tundishType: "Tipo de Distribuidor",
      sequence: "Sequência",
