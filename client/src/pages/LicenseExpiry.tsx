...
type DeliveryAttempt = { id: number; deliveryType: "scheduled" | "test"; channel: string; success: boolean; error: string | null; attemptedAt: string };
