...
- TV Dashboard System: Multi-department TV displays with configurable KPIs and video playback per department. Admin config page for dashboard/KPI/video management. Public routes at `/tv-dashboard/:id` (no auth required). Dark theme full-screen display with auto-refresh.
