...
- [Notification audit reliability](notification-audit-reliability.md) — delivery audit writes must be best-effort so logging failures never trigger duplicate notifications.
